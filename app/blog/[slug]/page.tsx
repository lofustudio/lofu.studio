        ...
        <>
            <article className="p-2 py-4 mx-auto max-w-[800px]">
                <div className="flex flex-col gap-2 pb-2">
                    <h1 className="text-4xl font-black font-display sm:text-5xl">{post.title}</h1>
                    ...
                    <Image src={post.image} alt="hero image" height={400} width={800} className="mt-4 border rounded-lg border-black/10 dark:border-white/10" />
                </div>
