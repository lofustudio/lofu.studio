...
export default function BlogPage() {
    ...
    return (
        <>
            <div className="max-w-[1200px] w-full flex flex-col items-start gap-2 pt-4">
                <div>
                ...
                <div className="grid grid-cols-1 gap-4 px-2 sm:px-0 sm:gap-2 sm:grid-cols-2 md:grid-cols-3">
