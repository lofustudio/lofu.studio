...
import { Binary, Box, Code, ExternalLink, Pen } from "lucide-react";
            ...
            <div className="flex flex-col w-full max-w-3xl gap-4 p-2 text-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400">
                        Lofu Studio is a small group of software makers, design
                        thinkers, and product builders.
                    </p>
                </div>
                <div className="flex flex-row items-center justify-center w-full gap-4">
                    <Link href="/projects" className="flex flex-row gap-2">
                        <Button size="sm">Our Work</Button>
                    </Link>
                ...
                <div className="flex flex-col items-center gap-2 text-center mt-80">
                    ...
                    <p className="text-neutral-500 dark:text-neutral-400">
                        <Balancer>
                            Security, speed and transparency are our top
                            priorities and we make sure that each and every one
                            of our products meets those criteria, so you can
                            worry less about the technical stuff and focus on
                            sending that cat meme to your friend.
                        </Balancer>
                    </p>
                    <div className="flex flex-col items-center w-full gap-2 py-4">
                        <ProjectCol
                            title="Horizon"
                            desc="A stupidly simple music app that syncs your library between devices."
                            href="https://github.com/lofustudio/horizon"
                            year={2023}
                            img={"/assets/banners/horizon.webp"}
                        />
                        <ProjectCol
                            title="Arisu"
                            desc="An all-in-one, easy to host, multi-purpose Discord bot."
                        ...
                        <ProjectCol
                            title="lofu.studio"
                            desc="The official Lofu Studio website. Build by @tygerxqt"
            ...
            <Link href={`/blog`}>
              <button className="w-full min-h-[550px] border border-black/10 dark:border-white/10 flex flex-col p-0 m-0 rounded-lg text-start sm:hover:-translate-y-1 transition-transform">
                ...
                <div className="flex flex-col items-center gap-2 my-40 text-center">
                    <p className="flex flex-row flex-wrap items-center justify-center gap-2 text-3xl font-bold text-center sm:text-4xl">
                        <ExternalLink className="h-9 w-9" /> Hidden in plain
                        sight.
                    </p>
                    <p className="text-neutral-500 dark:text-neutral-400">
                        <Balancer>
                            We're all over the world wide web, you can find us
                            on all the major social media platforms.
                            {/* We also
                            have a Discord server where you can hang out with us
